...
public class SMArchaeologyLoot implements LootTableSubProvider {
    ...
    public void generate(BiConsumer<ResourceLocation, LootTable.Builder> pOutput) {
        ...
        pOutput.accept(SMBuiltInLootTables.OVERWORLD_ARTIFACTS, LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                ...
                .add(LootItem.lootTableItem(SMItems.BROKEN_CUP.get()).setWeight(ARTIFACT_COMMON_WEIGHT))
                .add(LootItem.lootTableItem(SMItems.CAVE_CARROT.get()).setWeight(ARTIFACT_COMMON_WEIGHT)).when(belowY(45))
                .add(LootItem.lootTableItem(SMItems.COPPER_SPOON.get()).setWeight(ARTIFACT_COMMON_WEIGHT))
                .add(LootItem.lootTableItem(SMItems.PRIMITIVE_NECKLACE.get()).setWeight(ARTIFACT_COMMON_WEIGHT))
                //Uncommon
                ...
                .add(LootItem.lootTableItem(SMItems.BROKEN_MUG.get()).setWeight(ARTIFACT_UNCOMMON_WEIGHT))
                .add(LootItem.lootTableItem(SMItems.LOST_SHOE.get()).setWeight(ARTIFACT_UNCOMMON_WEIGHT))
                .add(LootItem.lootTableItem(SMItems.PETRIFIED_PILLBUG.get()).setWeight(ARTIFACT_UNCOMMON_WEIGHT)).when(IS_DEEPSLATE_CAVE)
                .add(LootItem.lootTableItem(SMItems.SOAKED_BOOK.get()).setWeight(ARTIFACT_UNCOMMON_WEIGHT))
                //Rare
                ...
                .add(LootItem.lootTableItem(SMItems.JADE_RING.get()).setWeight(ARTIFACT_RARE_WEIGHT)).when(isJungle())
                .add(LootItem.lootTableItem(SMItems.LOST_BESTIARY.get()).setWeight(ARTIFACT_RARE_WEIGHT))
                .add(LootItem.lootTableItem(SMItems.LOST_PICTURE_BOOK.get()).setWeight(ARTIFACT_RARE_WEIGHT)).when(IS_DEEPSLATE_CAVE)
                .add(LootItem.lootTableItem(SMItems.SNAPPED_PAINTBRUSH.get()).setWeight(ARTIFACT_RARE_WEIGHT))
                .add(LootItem.lootTableItem(SMItems.STRANGE_FUR.get()).setWeight(ARTIFACT_RARE_WEIGHT)).when(isMountain())
                //Very Rare
                ...
                .add(LootItem.lootTableItem(SMItems.BROKEN_FANCY_DAGGER.get()).setWeight(ARTIFACT_VERY_RARE_WEIGHT))
                .add(LootItem.lootTableItem(SMItems.DARK_TABLET.get()).setWeight(ARTIFACT_VERY_RARE_WEIGHT))
                .add(LootItem.lootTableItem(SMItems.EYE_TABLET.get()).setWeight(ARTIFACT_VERY_RARE_WEIGHT))
                .add(LootItem.lootTableItem(SMItems.FOSSILISED_BEAK.get()).setWeight(ARTIFACT_VERY_RARE_WEIGHT))
                .add(LootItem.lootTableItem(SMItems.GLOOMY_TABLET.get()).setWeight(ARTIFACT_VERY_RARE_WEIGHT))
                .add(LootItem.lootTableItem(SMItems.SMALL_DIAMOND_GEODE.get()).setWeight(ARTIFACT_VERY_RARE_WEIGHT)).when(belowY(-20))
                .add(LootItem.lootTableItem(SMItems.SMALL_EMERALD_GEODE.get()).setWeight(ARTIFACT_VERY_RARE_WEIGHT)).when(isMountain().and(belowY(30)))
                .add(LootItem.lootTableItem(SMItems.STONE_MASK.get()).setWeight(ARTIFACT_VERY_RARE_WEIGHT))
                //Extremely Rare
                ...
                .add(LootItem.lootTableItem(SMItems.ANCIENT_RELIC.get()).setWeight(ARTIFACT_EXTREMELY_RARE_WEIGHT))
                .add(LootItem.lootTableItem(SMItems.GOLDEN_IDOL.get()).setWeight(ARTIFACT_EXTREMELY_RARE_WEIGHT))
