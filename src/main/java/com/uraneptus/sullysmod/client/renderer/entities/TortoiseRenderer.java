...
public class TortoiseRenderer <E extends Tortoise> extends GeoEntityRenderer<E> {
    ...
    @Override
    public void renderEarly(E animatable, PoseStack stackIn, float ticks, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float partialTicks) {
