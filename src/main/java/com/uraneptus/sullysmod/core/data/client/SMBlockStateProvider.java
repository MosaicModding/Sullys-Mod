...
public class SMBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        modStairsBlock(SMBlocks.POLISHED_SMALL_JADE_BRICK_STAIRS.get(), SMDatagenUtil.SMALL_JADE_BRICKS);
        ...
        modStairsBlock(SMBlocks.SMOOTHED_ROUGH_JADE_STAIRS.get(), SMDatagenUtil.SMOOTHED_ROUGH_JADE);
        ...
        modSlabBlock(SMBlocks.POLISHED_SMALL_JADE_BRICK_SLAB.get(), SMDatagenUtil.SMALL_JADE_BRICKS);
        ...
        modVerticalSlabBlock(SMBlocks.SMOOTH_ROUGH_JADE_VERTICAL_SLAB.get(), SMDatagenUtil.SMOOTHED_ROUGH_JADE);
