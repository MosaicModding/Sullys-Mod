...
public class SMAdventureAdvancements implements ForgeAdvancementProvider.AdvancementGenerator {
    ...
    public void generate(HolderLookup.Provider registries, Consumer<Advancement> saver, ExistingFileHelper existingFileHelper) {
        ...
        Advancement POLISH_JADE = Advancement.Builder.advancement().display(SMItems.POLISHED_JADE.get(), SMTextDefinitions.POLISH_JADE_ADV.getLeft(), SMTextDefinitions.POLISH_JADE_ADV.getRight(), null, FrameType.TASK, true, true, false).parent(JADE_GRINDSET).addCriterion("polished_jade", new Criterion(InventoryChangeTrigger.TriggerInstance.hasItems(SMItems.POLISHED_JADE.get()))).requirements(RequirementsStrategy.OR).save(saver, SullysMod.modPrefix("adventure/" + SMTextDefinitions.POLISH_JADE_ADV_NAME), existingFileHelper);
