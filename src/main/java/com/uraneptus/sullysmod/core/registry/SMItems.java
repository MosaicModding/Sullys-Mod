...
public class SMItems {
    ...
    //Artifacts
    public static final RegistryObject<Item> BROKEN_VASE = registerArtifact("broken_vase", "A large piece of the side is missing");
    public static final RegistryObject<Item> PRIMITIVE_KNIFE = registerArtifact("primitive_knife", "A small knife made from obsidian");
    public static final RegistryObject<Item> MINERS_HELMET = registerArtifact("miners_helmet", "Looks like it’s previous owner couldn’t get the candle lit anymore", () -> new ArtifactHelmetItem(SMArmorMaterials.MINERS_HELMET, SMProperties.Items.ARTIFACT, MinersHelmetModel.INSTANCE));
    public static final RegistryObject<Item> SMALL_DENTED_HELMET = registerArtifact("small_dented_helmet", "A small rusty helmet. Barely fits", () -> new ArtifactHelmetItem(SMArmorMaterials.SMALL_DENTED_HELMET, SMProperties.Items.ARTIFACT));
    public static final RegistryObject<Item> LOST_CROWN = registerArtifact("lost_crown", "Once belonged to the king of a now fallen kingdom", () -> new ArtifactHelmetItem(SMArmorMaterials.LOST_CROWN, SMProperties.Items.ARTIFACT));
    public static final RegistryObject<Item> JADE_AMULET = registerArtifact("jade_amulet", "A creature is carefully sculpted from the stone");
    public static final RegistryObject<Item> PRIMITIVE_RING = registerArtifact("primitive_ring", "A roughly made metal ring");
    public static final RegistryObject<Item> RUSTY_TOOLS = registerArtifact("rusty_tools", "Maybe their owners are still out there");
    public static final RegistryObject<Item> BROKEN_BOWL = registerArtifact("broken_bowl", "A large crack runs down the edge");
    public static final RegistryObject<Item> COPPER_COG = registerArtifact("copper_cog", "Said to have been part of living creatures");
    public static final RegistryObject<Item> PETRIFIED_COOKIE = registerArtifact("petrified_cookie", "Petrified food is still food, just extra crisp");
    public static final RegistryObject<Item> ARROWHEAD = registerArtifact("arrowhead", "The tip of an ancient arrow");
    public static final RegistryObject<Item> DEATH_WHISTLE = registerArtifact("death_whistle", "Screeches horrible noises when blown into");
    public static final RegistryObject<Item> OMINOUS_TABLET = registerArtifact("ominous_tablet", "A dark figure is carved into the stone");
    public static final RegistryObject<Item> MOON_TABLET = registerArtifact("moon_tablet", "Has a carved image of the moon");
    public static final RegistryObject<Item> STONE_IDOL = registerArtifact("stone_idol", "Almost looks alive");
    public static final RegistryObject<Item> RED_CAP = registerArtifact("red_cap", "A tiny red cap. It’s too small to wear and the fabric feels strange");
    public static final RegistryObject<Item> DRIED_CYAN_FLOWER = registerArtifact("dried_cyan_flower", "A delicate cyan flower that feels strangely familiar");
    public static final RegistryObject<Item> DRIED_RED_FLOWER = registerArtifact("dried_red_flower", "A delicate red flower that feels like home");
    public static final RegistryObject<Item> METALLIC_SKULL = registerArtifact("metallic_skull", "The a metallic skull attached to broken off bars");
    public static final RegistryObject<Item> LOST_BAG = registerArtifact("lost_bag", "A small lightweight bag sloppily sewn together");
    public static final RegistryObject<Item> MYSTERIOUS_PLATE = registerArtifact("mysterious_plate", "Made from an unknown material");
    public static final RegistryObject<Item> FAMILIAR_CUBE = registerArtifact("familiar_cube", "Hot to the touch and has strange growths on it");
    public static final RegistryObject<Item> AMBER_ENCASED_BUG = registerArtifact("amber_encased_bug", "A small bug that was covered by tree sap ages ago");
    public static final RegistryObject<Item> FOSSILISED_SHELLS = registerArtifact("fossilised_shells", "Shells from a sea creature that lived long ago");
    public static final RegistryObject<Item> FOSSILISED_BONE = registerArtifact("fossilised_bone", "A large bone of an extinct creature");
    public static final RegistryObject<Item> FOSSILISED_FOOTSTEP = registerArtifact("fossilised_footstep", "An ancient footprint that never faded");
    public static final RegistryObject<Item> FOSSILISED_FISH = registerArtifact("fossilised_fish", "The bones of a small fish from times past");
    public static final RegistryObject<Item> TORN_MANUSCRIPT = registerArtifact("torn_manuscript", "Part of a manuscript with an unknown language");
    public static final RegistryObject<Item> LOST_JOURNAL = registerArtifact("lost_journal", "Waterlogged and left unreadable, it has a few pages ripped out");
    public static final RegistryObject<Item> LOST_SKETCHBOOK = registerArtifact("lost_sketchbook", "A small book with scratchy drawings of an unknown large mouthed biped");
    public static final RegistryObject<Item> LOST_RECIPE_BOOK = registerArtifact("lost_recipe_book", "Mostly ruined and unreadable, but still has some recipes inside.");
    public static final RegistryObject<Item> GOLDEN_BELT_BUCKLE = registerArtifact("golden_belt_buckle", "Has a peculiar shape and it’s leather feels strange");
    public static final RegistryObject<Item> DEEPSLATE_VASE = registerArtifact("deepslate_vase", "Who would’ve needed a vase made from deepslate?");
    public static final RegistryObject<Item> SMALL_GEODE = registerArtifact("small_geode", "Kind of cute");
    public static final RegistryObject<Item> TORN_CLOTH = registerArtifact("torn_cloth", "A dirty torn off piece of clothing");
    public static final RegistryObject<Item> GOLDEN_GOBLET = registerArtifact("golden_goblet", "An old but beautiful chalice made by a skilled goldsmith");
    public static final RegistryObject<Item> EMERALD_EARRING = registerArtifact("emerald_earring", "Besides the beautiful emerald, it looks sloppily put together");
    public static final RegistryObject<Item> BROKEN_BOTTLE = registerArtifact("broken_bottle", "The top half of a bottle");
    public static final RegistryObject<Item> FROG_IDOL = registerArtifact("frog_idol", "Everybody likes frogs");
