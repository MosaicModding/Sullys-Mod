...
public class SMEntityTypes {
    ...
    public static final RegistryObject<EntityType<TortoiseEntity>> TORTOISE = HELPER.createLivingEntity("tortoise", TortoiseEntity::new, MobCategory.CREATURE, 1.1f, 1.0f);
}
