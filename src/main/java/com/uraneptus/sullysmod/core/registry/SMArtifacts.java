...
public class SMArtifacts {
    ...
    //Placeable
    public static final RegistryObject<Block> DRIED_CYAN_FLOWER = registerPlaceable("dried_cyan_flower", "A delicate cyan flower that feels strangely familiar", () -> new ArtifactFlowerBlock(SMProperties.Blocks.ARTIFACT_FLOWER), 21);
    ...
    public static final Pair<RegistryObject<Block>, RegistryObject<Block>> SNOUTED_ANCIENT_SKULL = registerAncientSkull(AncientSkullBlock.Types.SNOUTED, "Horrifying", 35);
    ...
    public static Pair<RegistryObject<Block>, RegistryObject<Block>> registerAncientSkull(AncientSkullBlock.Types type, String description, int price) {
        ...
        RegistryObject<Block> wallSkull = SMBlocks.createBlockNoItemNoLang(typeName + "_ancient_wall_skull", () -> new AncientWallSkullBlock(type, SMProperties.Blocks.ancientSkulls().lootFrom(skull)));
    ...
    private static RegistryObject<Block> registerPlaceable(String name, String description, Supplier<? extends Block> block, int price) {
        RegistryObject<Block> object = SMBlocks.createBlockNoItemNoLang(name, block);
    ...
    private static RegistryObject<Item> registerArtifact(String name, String description, Supplier<? extends Item> item, int price) {
        RegistryObject<Item> object = SMItems.createItem(name, item);
