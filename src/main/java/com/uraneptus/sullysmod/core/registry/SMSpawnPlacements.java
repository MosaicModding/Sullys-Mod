...
public class SMSpawnPlacements {
    ...
    public static void register() {
        SpawnPlacements.register(SMEntityTypes.LANTERNFISH.get(), SpawnPlacements.Type.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Lanternfish::checkLanternfishSpawnRules);
