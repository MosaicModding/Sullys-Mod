...
public class SMBlocksetTypes {
    public static final Supplier<BlockSetType> PETRIFIED_BLOCKSET = Suppliers.memoize(() -> createBlocksetType(
            "petrified",
            true,
            true,
            true,
            BlockSetType.PressurePlateSensitivity.MOBS,
            SMSounds.PETRIFIED_WOOD,
    ...
    public static final Supplier<BlockSetType> COPPER_BLOCKSET = Suppliers.memoize(() -> createBlocksetType(
            "copper",
            true,
            true,
            true,
            ...
            SoundEvents.METAL_PRESSURE_PLATE_CLICK_OFF,
            SoundEvents.METAL_PRESSURE_PLATE_CLICK_ON,
            SMSounds.COPPER_BUTTON_CLICK_OFF.get(),
            SMSounds.COPPER_BUTTON_CLICK_ON.get()));
    ...
    public static BlockSetType createBlocksetType(String name, boolean canOpenByHand, boolean canOpenByWindCharge, boolean canButtonBeActivatedByArrows, BlockSetType.PressurePlateSensitivity pressurePlateSensitivity, SoundType soundType, SoundEvent doorClose, SoundEvent doorOpen, SoundEvent trapdoorClose, SoundEvent trapdoorOpen, SoundEvent pressurePlateClickOff, SoundEvent pressurePlateClickOn, SoundEvent buttonClickOff, SoundEvent buttonClickOn) {
        return BlockSetTypeRegistryHelper.register(new BlockSetType(SullysMod.modPrefix(name).toString(), canOpenByHand, canOpenByWindCharge, canButtonBeActivatedByArrows, pressurePlateSensitivity, soundType, doorClose, doorOpen, trapdoorClose, trapdoorOpen, pressurePlateClickOff, pressurePlateClickOn, buttonClickOff, buttonClickOn));
    }
