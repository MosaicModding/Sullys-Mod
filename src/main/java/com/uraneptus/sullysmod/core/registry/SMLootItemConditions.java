...
public class SMLootItemConditions {
    ...
    public static final Supplier<LootItemConditionType> MOD_FEATURE_CONDITION_TYPE = ITEM_CONDITIONS.register("mod_feature_flag", () -> new LootItemConditionType(SMFeatureLootItemCondition.CODEC));
    }
