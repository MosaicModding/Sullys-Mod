...
public class Rascal extends PathfinderMob implements IAnimatable {
    ...
    static class RascalLookForDarkPlaceToFade extends Goal {
        ...
        public RascalLookForDarkPlaceToFade(PathfinderMob mob, double pSpeedModifier) {
            this.mob = mob;
        ...
        public boolean canUse() {
            ...
            if (target != null) {
                if (target.distanceToSqr(this.mob) < 256.0D) {
        ...
        protected Vec3 getHidePos() {
            ...
            for(int i = 0; i < 10; ++i) {
                ...
                if (/*!(this.mob.getLevel().getBrightness(LightLayer.BLOCK, this.mob.blockPosition()) == 0)*/ !this.mob.level.canSeeSky(blockpos1) && this.mob.getWalkTargetValue(blockpos1) < 0.0F) {
