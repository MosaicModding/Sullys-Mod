...
public class JadeSmithingTemplateItem extends SmithingTemplateItem {
    ...
    public JadeSmithingTemplateItem() {
        super(JADE_UPGRADE_APPLIES_TO, JADE_UPGRADE_INGREDIENTS, JADE_UPGRADE, JADE_UPGRADE_BASE_SLOT_DESCRIPTION, JADE_UPGRADE_ADDITIONS_SLOT_DESCRIPTION, List.of(EMPTY_SLOT_SHIELD), List.of(EMPTY_SLOT_INGOT));
    }
}
